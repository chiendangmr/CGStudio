...
namespace Svt.Caspar
{
	public class CGManager
	{
        ...
        public void Update(int layer, string xmlStr)
        {
            Channel.Connection.SendString("CG " + Channel.ID + " UPDATE " + layer + " " + " \"" + xmlStr + "\"");
        }
        public void Update(int videoLayer, int layer, string xmlStr)
        {
            if (videoLayer == -1)
                Update(layer, xmlStr);
            else
                Channel.Connection.SendString("CG " + Channel.ID + "-" + videoLayer + " UPDATE " + layer + " " + " \"" + xmlStr + "\"");
