package  {
	...
	public class socialMediaPush extends CasparTemplate {
		...
		public function socialMediaPush() {
			// constructor code
			super();
			this.addChild(rect);
			this.nextFormat.align = TextFormatAlign.LEFT;
			this.nextFormat.size = 60;
			...
			this.nameNext.multiline = false;
			this.nameNext.autoSize = "left";
			this.nameNext.width = 500;
			this.nameNext.height = 500;
			this.nameNext.text = "#brothersgreen";
		...
		{
			yTween = new Tween(nameNext, "x", Bounce.easeOut, 720, 100, 1, true);
		}
		private function comeOut(e:Event):void
		{
			yTween = new Tween(nameNext, "alpha", None.easeNone, 1, 0, 0.1, true);
			//yTween = new Tween(nameNext, "x", Bounce.easeOut, 50, 80, 1, true);
		}
