package  {
	...
	public class top8horse extends CasparTemplate{
		...
		public function top8horse() {
			...
			this.topNumber1.type = this.topNumber2.type= this.topNumber3.type= this.topNumber4.type = this.topNumber5.type =this.topNumber6.type = this.topNumber7.type = this.topNumber8.type = TextFieldType.DYNAMIC;
			...
			this.topS1.type = this.topS2.type= this.topS3.type= this.topS4.type = this.topS5.type =this.topS6.type = this.topS7.type = this.topS8.type = TextFieldType.DYNAMIC;
			...
			this.topNumber1.y = this.topS1.y = 250;
			...
			this.topNumber6.y = this.topS6.y = this.topNumber5.y + 63;
			this.topNumber7.y = this.topS7.y = this.topNumber6.y + 63;
			this.topNumber8.y = this.topS8.y = this.topNumber7.y + 63;
