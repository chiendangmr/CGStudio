			...
			for each (var element:XML in xml.children())
			{
				...
				switch(property.toLowerCase())
				{
					...
					case "2ndnumber".toLowerCase():
						this.txt4.text = data;
						break;
					case "2ndmoney".toLowerCase():
						this.txt5.text = data;
						break;
					case "2ndname".toLowerCase():
						this.txt11.text = data;
						comeIn31();
						break;
					...
					case "3rdnumber".toLowerCase():
						this.txt6.text = data;
						break;
					case "3rdmoney".toLowerCase():
						this.txt7.text = data;
						break;
					case "3rdname".toLowerCase():
						this.txt12.text = data;
						comeIn41();
						break;
					...
					case "4thnumber".toLowerCase():
						this.txt8.text = data;
						break;
					case "4thmoney".toLowerCase():
						this.txt9.text = data;
						break;
					case "4thname".toLowerCase():
						this.txt13.text = data;
						comeIn51();
						break;
