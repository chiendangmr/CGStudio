package  {
	...
	public class lfTicker extends CasparTemplate{
		...
		public function lfTicker() {
			...
			setTxt(t2, topFormat2, myFilter, "WIN:", 275, 845);
			this.txtGroup.addChild(t2);
			
			setTxt(t3, topFormat2, myFilter, "PLACE:", 275, 900);
			...
			this.topNumber1.type = this.topNumber2.type= this.topNumber3.type= this.topNumber4.type = this.topNumber5.type =this.topNumber6.type = this.topNumber7.type = TextFieldType.INPUT;
			...
			this.topS1.type = this.topS2.type= this.topS3.type= this.topS4.type = this.topS5.type =this.topS6.type = this.topS7.type = TextFieldType.INPUT;
			...
			this.topS11.type = this.topS21.type= this.topS31.type= this.topS41.type = this.topS51.type =this.topS61.type = this.topS71.type = TextFieldType.INPUT;
		...
		function GetProperties()
		{
			...
			xmlStr +=Add(xmlStr, "RaceName", t1);
			xmlStr +=Add(xmlStr, "RaceNumber", raceNumber);
			xmlStr +=Add(xmlStr, "txt2", txt2);
			xmlStr +=Add(xmlStr, "PlaceName", txt3);
			xmlStr +=Add(xmlStr, "t2", t2);
			xmlStr +=Add(xmlStr, "txt5", txt5);
			xmlStr +=Add(xmlStr, "topNumber1", topNumber1);
			xmlStr +=Add(xmlStr, "topNumber2", topNumber2);
			xmlStr +=Add(xmlStr, "topNumber3", topNumber3);
			xmlStr +=Add(xmlStr, "topNumber4", topNumber4);
			xmlStr +=Add(xmlStr, "topNumber5", topNumber5);
			xmlStr +=Add(xmlStr, "topNumber6", topNumber6);
			xmlStr +=Add(xmlStr, "topNumber7", topNumber7);
			xmlStr +=Add(xmlStr, "topS1", topS1);
			xmlStr +=Add(xmlStr, "topS2", topS2);
			xmlStr +=Add(xmlStr, "topS3", topS3);
			xmlStr +=Add(xmlStr, "topS4", topS4);
			xmlStr +=Add(xmlStr, "topS5", topS5);
			xmlStr +=Add(xmlStr, "topS6", topS6);
			xmlStr +=Add(xmlStr, "topS7", topS7);
			xmlStr +=Add(xmlStr, "topS11", topS11);
			xmlStr +=Add(xmlStr, "topS21", topS21);
			xmlStr +=Add(xmlStr, "topS31", topS31);
			xmlStr +=Add(xmlStr, "topS41", topS41);
			xmlStr +=Add(xmlStr, "topS51", topS51);
			xmlStr +=Add(xmlStr, "topS61", topS61);
			xmlStr +=Add(xmlStr, "topS71", topS71);
			...
			for each (var element:XML in xml.children())
			{
				...
				switch(property.toLowerCase())
				{
					case "Field_1".toLowerCase():
						this.topFormat.color = toHex(data);
						this.topFormat2.color = toHex(data);
						if(data=="0x124089"){
							this.topFormat.size = 80;
						}
						this.topNumber1.defaultTextFormat = topFormat;
						this.topS1.defaultTextFormat = this.topS11.defaultTextFormat = topFormat2;
						break;
					case "Field_2".toLowerCase():
						...
						this.topNumber2.defaultTextFormat = topFormat;
						this.topS2.defaultTextFormat = this.topS21.defaultTextFormat = topFormat2;
						break;
					case "Field_3".toLowerCase():
						...
						this.topNumber3.defaultTextFormat = topFormat;
						this.topS3.defaultTextFormat = this.topS31.defaultTextFormat = topFormat2;
						break;
					case "Field_4".toLowerCase():
						...
						this.topNumber4.defaultTextFormat = topFormat;
						this.topS4.defaultTextFormat = this.topS41.defaultTextFormat = topFormat2;
						break;
					case "Field_5".toLowerCase():
						...
						this.topNumber5.defaultTextFormat = topFormat;
						this.topS5.defaultTextFormat = this.topS51.defaultTextFormat = topFormat2;
						break;
					case "Field_6".toLowerCase():
						...
						this.topNumber6.defaultTextFormat = topFormat;
						this.topS6.defaultTextFormat = this.topS61.defaultTextFormat = topFormat2;
						break;
					case "Field_7".toLowerCase():
						...
						this.topNumber7.defaultTextFormat = topFormat;
						this.topS7.defaultTextFormat = this.topS71.defaultTextFormat = topFormat2;
						break;
		...
		public function setPro(d:TextField)
		{			
		...
		private function update(tevt:TimerEvent):void {
			...
			if ( (hr<10) && (min < 10)) {			
				txt2.text = "0"+ String(hr) + ":0" + String(min);
			}else if ( (hr<10) && (min >= 10)) {			
				txt2.text = "0"+ String(hr) + String(min);
			}
			else if ((hr>=10) && (min<10)){
				txt2.text = String(hr) + ":0" + String(min);
			}
				else {
				txt2.text = String(hr) + ":" + String(min);
			}
		}
	}
