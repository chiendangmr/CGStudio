package  {
	...
	public class top8horse extends CasparTemplate{
		...
		public var icon5:UILoader = null;
		public var icon6:UILoader = null;
		public var icon7:UILoader = null;
		public var icon8:UILoader = null;		
		...
		public var winPool:TextField = new TextField();
		...
		public function top8horse() {
			...
			setTxt(txt3, txtFormat, myFilter, "MADAGUI", this.txt.x, 120);
			...
			this.topNumber1.y = this.topS1.y = 230;
			this.topNumber2.y = this.topS2.y = this.topNumber1.y + 55;
			this.topNumber3.y = this.topS3.y = this.topNumber2.y + 56;
			this.topNumber4.y = this.topS4.y = this.topNumber3.y + 57;
			this.topNumber5.y = this.topS5.y = this.topNumber4.y + 55;
			this.topNumber6.y = this.topS6.y = this.topNumber5.y + 56;
			this.topNumber7.y = this.topS7.y = this.topNumber6.y + 57;
			this.topNumber8.y = this.topS8.y = this.topNumber7.y + 55;
			this.topNumber1.text = "1.";
			this.topNumber8.text = "8.";
			this.topNumber2.text = "2.";
			this.topNumber3.text = "3.";
			this.topNumber4.text = "4.";
			this.topNumber5.text = "7.";
			this.topNumber6.text = "6.";
			this.topNumber7.text = "5.";
			...
			this.dFormat.underline = true;
			this.d1.defaultTextFormat = dFormat;
			this.d1.filters = this.winPool.filters = this.winValue.filters = [myFilter];
			...
			this.txtGroup.addChild(icon4);
			this.txtGroup.addChild(icon5);
			this.txtGroup.addChild(icon6);
			this.txtGroup.addChild(icon7);
			this.txtGroup.addChild(icon8);
			this.txtGroup.addChild(winPool);
		...
		function GetProperties()
		{
			...
			xmlStr +=Add(xmlStr, "topNumber8", topNumber8);
			...
			for each (var element:XML in xml.children())
			{
				...
				switch(property.toLowerCase())
				{
					...
					case "topNumber7".toLowerCase():
						...
						request = new URLRequest(getIcon(data));
						this.icon7.load(request);
						break;
					case "topS7".toLowerCase():
						this.topS7.text = data.toUpperCase();
						break;
					case "topNumber8".toLowerCase():
						this.topNumber8.text = data.toUpperCase();
						request = new URLRequest(getIcon(data));
						this.icon8.load(request);
						break;
					case "topS8".toLowerCase():
