package  {
	...
	public class ffMarketOrder extends CasparTemplate {
		...
		public function ffMarketOrder() {
			...
			this.fMainTitle.x = this.fTime.x;
			this.fMainTitle.y = 220;
			this.fMainTitle.text = "MARKET ORDER";
			...
			this.f1Number.x = 265;
			this.f1Number.y = this.fMainTitle.y + 70;
			...
			this.f2Number.y = this.f1Number.y + 63;
			...
			this.f3Number.y = this.f2Number.y + 63;
			...
			this.f4Number.y = this.f3Number.y + 63;
			...
			this.f5Number.y = this.f4Number.y + 63;
			...
			this.f6Number.y = this.f5Number.y + 63;
			...
			this.f7Number.y = this.f6Number.y + 63;
			...
			this.f8Number.y = this.f7Number.y + 63;
			...
			setTxt(txt2, f1Format, myFilter, "9.", this.f8Number.x, this.f8Number.y+63);
			setTxt(txt3, f1Format, myFilter, "STORM GOD", this.f8Name.x, this.txt2.y);
			setTxt(txt4, f1Format, myFilter, "13.90", this.f8Win.x, this.txt2.y);
			setTxt(txt5, f1Format, myFilter, "3.80", this.f8Place.x, this.txt2.y);
			setTxt(txt6, f1Format, myFilter, "10.", this.f8Number.x, this.txt2.y + 63);
			setTxt(txt7, f1Format, myFilter, "STORM GOD", this.f8Name.x, this.txt6.y);
			setTxt(txt8, f1Format, myFilter, "13.90", this.f8Win.x, this.txt6.y);
			setTxt(txt9, f1Format, myFilter, "3.80",  this.f8Place.x, this.txt6.y);
		...
		function GetProperties()
		{
			...
			xmlStr +=Add(xmlStr, "f9Number", txt2);
			xmlStr +=Add(xmlStr, "f9Name", txt3);
			xmlStr +=Add(xmlStr, "f9Win", txt4);
			xmlStr +=Add(xmlStr, "f9Place", txt5);
			xmlStr +=Add(xmlStr, "f10Number", txt6);
			xmlStr +=Add(xmlStr, "f10Name", txt7);
			xmlStr +=Add(xmlStr, "f10Win", txt8);
			xmlStr +=Add(xmlStr, "f10Place", txt9);
			...
			for each (var element:XML in xml.children())
			{
				...
				switch(property.toLowerCase())
				{
					...
					case "Field_9".toLowerCase():
						this.f1Format.color = toHex(data);
						this.txt2.defaultTextFormat = this.txt3.defaultTextFormat = this.txt4.defaultTextFormat = this.txt5.defaultTextFormat = f1Format;
						break;
					case "Field_10".toLowerCase():
						this.f1Format.color = toHex(data);
						this.txt6.defaultTextFormat = this.txt7.defaultTextFormat = this.txt8.defaultTextFormat = this.txt9.defaultTextFormat = f1Format;
						break;
		...
		private function update(tevt:TimerEvent):void {
			...
			var msec:Number = now.milliseconds;
			if ( (hr<10) && (min < 10)) {			
				fTime.text = "0"+ String(hr) + ":0" + String(min) + ":" + String(sec) + ":" + String(msec);
			}else if ( (hr<10) && (min >= 10)) {			
				fTime.text = "0"+ String(hr) + String(min)+ ":" + String(sec) + ":" + String(msec);
			}
			else if ((hr>=10) && (min<10)){
				fTime.text = String(hr) + ":0" + String(min)+ ":" + String(sec) + ":" + String(msec);
			}
				else {
				fTime.text = String(hr) + ":" + String(min)+ ":" + String(sec) + ":" + String(msec);
			}
		}
	}
