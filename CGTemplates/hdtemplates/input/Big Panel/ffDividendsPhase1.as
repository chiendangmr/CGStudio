package  {
	...
	public class ffDividendsPhase1 extends CasparTemplate {
		...
		public function ffDividendsPhase1() {
			// constructor code
			super();
			...
			setTxt(txt1, f3Format, myFilter, "QUINELLA:", this.f1Number.x, 715);
			setTxt(txt2, f3Format, myFilter, "TRIFECTA:", 1025, 715);
			...
			setTxt(txt3, f3Format, myFilter, "1-7", 500, 715);
			setTxt(txt4, f3Format, myFilter, "106.40", 740, 715);
			setTxt(txt5, f3Format, myFilter, "7-1-3", 1225, 715);
			setTxt(txt6, f3Format, myFilter, "712.30", 1500, 715);
			...
			setTxt(d5, dFormat, myFilter, "đ", 730, 715);
			setTxt(d6, dFormat, myFilter, "đ", 1485, 715);
		...
		function GetProperties()
		{
			...
			xmlStr += '<fBet id="bettingCode"><data value="' + this.fBet.text + '"/></fBet>';
			xmlStr += '<f1Number id="dividendsNumber1"><data value="' + this.f1Number.text + '"/></f1Number>';
			xmlStr += '<f1Name id="dividendsName1"><data value="' + this.f1Name.text + '"/></f1Name>';
			xmlStr += '<f1Win id="dividendsWin1"><data value="' + this.f1Win.text + '"/></f1Win>';
			xmlStr += '<f1Place id="dividendsPlace1"><data value="' + this.f1Place.text + '"/></f1Place>';
			...
			xmlStr += '<f2Name id="dividendsTrainer1"><data value="' + this.f2Name.text + '"/></f2Name>';			
			xmlStr += '<f3Number id="dividendsNumber2"><data value="' + this.f3Number.text + '"/></f3Number>';
			xmlStr += '<f3Name id="dividendsName2"><data value="' + this.f3Name.text + '"/></f3Name>';			
			xmlStr += '<f3Place id="dividendsPlace2"><data value="' + this.f3Place.text + '"/></f3Place>';
			xmlStr += '<f4Name id="dividensTrainer2"><data value="' + this.f4Name.text + '"/></f4Name>';
			xmlStr += '<f5Number id="dividendsNumber3"><data value="' + this.f5Number.text + '"/></f5Number>';
			xmlStr += '<f5Name id="dividendsName3"><data value="' + this.f5Name.text + '"/></f5Name>';
			xmlStr += '<f5Place id="dividendsPlace3"><data value="' + this.f5Place.text + '"/></f5Place>';
			
			xmlStr += '<f6Name id="dividendsTrainer3"><data value="' + this.f6Name.text + '"/></f6Name>';
