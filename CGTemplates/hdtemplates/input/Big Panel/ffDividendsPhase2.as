package  {
	...
	public class ffDividendsPhase2 extends CasparTemplate {
		...
		private var txt21:TextField = new TextField();
		...
		private var txt20:TextField = new TextField();
		...
		public function ffDividendsPhase2() {
			// constructor code
			super();
			...
			setTxt(txt7, f3Format, myFilter, "1-7", this.txt3.x, 735);
			setTxt(txt8, f3Format, myFilter, "106.40", this.txt4.x, this.txt7.y);
			setTxt(txt9, f3Format, myFilter, "7-1-3", this.txt5.x, this.txt7.y);
			setTxt(txt10, f3Format, myFilter, "712.30", this.txt6.x, this.txt7.y);			
			
			setTxt(txt13, f3Format, myFilter, "7-1-3", this.txt5.x, 775);
			setTxt(txt14, f3Format, myFilter, "712.30", this.txt6.x, this.txt13.y);	
			setTxt(txt15, f3Format, myFilter, "1-7", this.txt3.x, this.txt13.y);
			setTxt(txt16, f3Format, myFilter, "106.40", this.txt4.x, this.txt13.y);			
			
			setTxt(txt20, f3Format, myFilter, "106.40", this.txt5.x, 815);
			setTxt(txt21, f3Format, myFilter, "106.40", this.txt6.x, this.txt20.y);
			...
			setTxt(txt11, f3Format, myFilter, "EXACTA:", this.f1Number.x, this.txt7.y);
			setTxt(txt17, f3Format, myFilter, "TRIO:", this.f1Number.x, this.txt13.y);
			setTxt(txt19, f3Format, myFilter, "QUARTET:", this.txt2.x, this.txt7.y);
			setTxt(txt18, f3Format, myFilter, "SUPERFECTA6:", this.txt2.x, this.txt13.y);
			setTxt(txt12, f3Format, myFilter, "PICKX JACKPOT:", this.txt2.x, this.txt20.y);
			...
			setTxt(d9, dFormat, myFilter, "đ", this.d5.x, this.txt13.y);
			setTxt(d10, dFormat, myFilter, "đ", this.d6.x, this.d9.y);
			setTxt(d11, dFormat, myFilter, "đ", this.d6.x, this.txt20.y);
			this.addChild(d1);
			this.addChild(d2);
			this.addChild(d3);
			this.addChild(d4);
